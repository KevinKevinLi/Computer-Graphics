...
function setupCubeMap() {
	...
	// See uage of gl.texParameteri
	 ...
	 var imageCt = 0;  // Number of images that have finished loading.
	    ...
	    load( "neg-x.png", gl.TEXTURE_CUBE_MAP_NEGATIVE_X );
	    load( "pos-x.png", gl.TEXTURE_CUBE_MAP_POSITIVE_X );
	    load( "neg-y.png", gl.TEXTURE_CUBE_MAP_NEGATIVE_Y );
	    load( "pos-y.png", gl.TEXTURE_CUBE_MAP_POSITIVE_Y );
	    load( "neg-z.png", gl.TEXTURE_CUBE_MAP_NEGATIVE_Z );
	    load( "pos-z.png", gl.TEXTURE_CUBE_MAP_POSITIVE_Z );
